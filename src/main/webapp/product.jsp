	...
	<header id="header" class="header fixed-top">
		<div
			...
			<a href="index.html" class="logo d-flex align-items-center"> <img
				src="assets/img/logo.png" alt=""> <span>FlexStart</span>
			</a>
		...
		<section id="features" class="features">
			...
			<div class="container" data-aos="fade-up">
				...
				<div class="row feture-tabs" data-aos="fade-up">
					<div class="col-lg-6">
						<h3>Neque officiis dolore maiores et exercitationem quae est
							seda lidera pat claero</h3>

						<!-- Tabs -->
						<ul class="nav nav-pills mb-3">
							<li><a class="nav-link active" data-bs-toggle="pill"
								href="#tab1">Saepe fuga</a></li>
							<li><a class="nav-link" data-bs-toggle="pill" href="#tab2">Voluptates</a>
							</li>
							<li><a class="nav-link" data-bs-toggle="pill" href="#tab3">Corrupti</a>
							</li>
						</ul>
						<!-- End Tabs -->
						...
						<div class="tab-content">
							...
							<div class="tab-pane fade show active" id="tab1">
								<p>Consequuntur inventore voluptates consequatur aut vel et.
									Eos doloribus expedita. Sapiente atque consequatur minima nihil
									quae aspernatur quo suscipit voluptatem.</p>
								<div class="d-flex align-items-center mb-2">
									<i class="bi bi-check2"></i>
									<h4>Repudiandae rerum velit modi et officia quasi facilis</h4>
								</div>
								<p>Laborum omnis voluptates voluptas qui sit aliquam
									blanditiis. Sapiente minima commodi dolorum non eveniet magni
									quaerat nemo et.</p>
								<div class="d-flex align-items-center mb-2">
									<i class="bi bi-check2"></i>
									<h4>Incidunt non veritatis illum ea ut nisi</h4>
								</div>
								<p>Non quod totam minus repellendus autem sint velit. Rerum
									debitis facere soluta tenetur. Iure molestiae assumenda sunt
									qui inventore eligendi voluptates nisi at. Dolorem quo tempora.
							...
							<div class="row align-self-center gy-4">
								...
								<div class="col-md-6 icon-box" data-aos="fade-up"
									...
									<div>
										...
										<p>Expedita veritatis consequuntur nihil tempore
											laudantium vitae denat pacta</p>
									</div>
								</div>
				...
				<div class="row gy-4">
					...
					<div class="col-lg-4 col-md-6" data-aos="fade-up"
						...
						<div class="service-box blue">
							<i class="icon"><img src="assets/img/product/All-American-Burger-1400x700.jpg" class="img-fluid" alt="Girl in  jacket"></i>
							<h3>Breakfast</h3>
					...
					<div class="col-lg-4 col-md-6" data-aos="fade-up"
						...
						<div class="service-box orange">
							<i class="icon"><img src="assets/img/product/Cheeseburger-and-Fries.jpg" class="img-fluid" alt="Girl in  jacket"></i>
							<h3>Lunch/Dinner</h3>
					...
					<div class="col-lg-4 col-md-6" data-aos="fade-up"
						...
						<div class="service-box green">
							<i class="icon"><img src="assets/img/product/Spicy-Mexican-Burger-and-Fries.jpg" class="img-fluid" alt="Girl in  jacket"></i>
					...
					<div class="col-lg-4 col-md-6" data-aos="fade-up"
						...
						<div class="service-box purple">
							<i class="icon"><img src="assets/img/product/French-Fries-and-Onion-Rings.jpg" class="img-fluid" alt="Girl in  jacket"></i>
							<h3>Side Dishes</h3>
					...
					<div class="col-lg-4 col-md-6" data-aos="fade-up"
						...
						<div class="service-box pink">
							<i class="icon"><img src="assets/img/product/Classic-Shakes.jpg" class="img-fluid" alt="Girl in  jacket"></i>
							<h3>Desserts</h3>
							...
							<div class="accordion-item">
								<h2 class="accordion-header">
									<button class="accordion-button collapsed" type="button"
										...
										Non consectetur a erat nam at lectus urna duis?</button>
								</h2>
							...
							<div class="accordion-item">
								...
								<div id="faq2-content-3" class="accordion-collapse collapse"
									...
									<div class="accordion-body">Laoreet sit amet cursus sit
										amet dictum sit amet justo. Mauris vitae ultricies leo integer
										malesuada nunc vel. Tincidunt eget nullam non nisi est sit
										amet. Turpis nunc eget lorem dolor sed. Ut venenatis tellus in
										metus vulputate eu scelerisque. Pellentesque diam volutpat
