...
<body>
	...
	if (rs.next()) {
		...
		brief_description = rs.getString("brief_description");
		detail_description = rs.getString("detail_description");
		cost_price = Double.parseDouble(rs.getString("cost_price"));
		retail_price = Double.parseDouble(rs.getString("retail_price"));
		stock_quantity = Integer.parseInt(rs.getString("stock_quantity"));
	} else {
				...
				<div>
					<div class="row feture-tabs" data-aos="fade-up">
						...
						<h4 class="sech4" style="font-family: 'Pangolin'; font-size: 3em">Admin
							Console - Edit product</h4>
					</div>
				</div>
				<div class="row g-5">
					<div class="col-md-11 col-lg-11">
						<form class="needs-validation" method="POST" action="EditProductDetails"
							...
							<div class="row g-3">
								...
								<div class="col-sm-12">
									<label for="productTitle" class="form-label">Product
										...
										id="productTitle" placeholder="" value="<%=product_title%>"
								...
								<div class="col-sm-12">
									...
									<textarea type="text" class="form-control"
										...
										name="briefDescription" required><%=brief_description%>
										</textarea>
								...
								<div class="col-sm-12">
									...
									<textarea type="text" class="form-control"
										...
										name="detailedDescription" required><%=detail_description%>
										</textarea>
								...
								<div class="col-sm-4">
									<label for="costPrice" class="form-label">Cost Price</label><input
										...
										placeholder="" value="<%=cost_price%>" name="costPrice"
								...
								<div class="col-sm-4">
									<label for="retailPrice" class="form-label">Retail
										...
										id="retailPrice" placeholder="2.10" min="0.00" step="0.01"
										value="<%=retail_price%>" name="retailPrice" required>
								...
								<div class="col-sm-4">
									<label for="stockQuantity" class="form-label">Stock
										...
										id="retailPrice" placeholder="" value="<%=stock_quantity%>"
										name="stockQuantity" min="0" step="1" required>
